        ...
        <v-card>
            ...
            <v-row>
                <v-col cols="12" sm="12" md="3" lg="3" class="pl-10">
                    <img 
                        :src="user.profile.path || '/img/user.png'" 
                    ...
                    <v-file-input 
                        ...
                        ref="imageFile" 
                        v-model="file"
                        accept="image/png, image/jpg, image/bnp"
                    >
                    </v-file-input>
                    <v-btn
                        color="primary"
                ...
                <v-col cols="12" sm="12" md="9" lg="9" class="pl-10">
                    <v-card-text>
                        <v-text-field 
...
export default {
    ...
    methods: {
        ...
        saveUser() {
            ...
            Meteor.call('user.updatePersonalData',{ user: this.user ,
             photoFileUser: this.photoFileUser}, (error, response) => {
